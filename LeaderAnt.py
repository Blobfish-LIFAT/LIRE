...
class LeaderAnt:
    ...
    def get_cluster_index_and_cluster_elements_per_point_index(self,index):
        for cluster_index , cluster_elements in self.clusters.items():
            if(index in cluster_elements):
                return cluster_index,cluster_elements
        return (-1,-1)
